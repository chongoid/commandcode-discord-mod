...
export interface Config {botToken: string; allowedUsers: string[]; allowedRoles: string[]; guildId?: string; channelName: string; workingDir: string; yolo: boolean; maxTurns: number; timeoutMs: number; stateFile: string; legacyFile: string; lockFile: string; cmdPath: string}
